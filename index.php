...
<html lang="en">
  <head>
    ...
    <title>KLD Paradise | Homepage</title>
  </head>
  <style>
  ...
  <body>
    ...
    <header class="header" id="home">
      <div class="section__container header__container">
        <p class="section__subheader" style="color:black;">ABOUT US</p>
        <h1 style="color:black;">Paradise isn't a place,<br />It's a feeling.</h1>
      ...
      <div class="section__container booking__container">
        <form action="/">
          <div class="input__group">
            ...
            <input type="date" placeholder="Your Check In Date" />
          </div>
          <div class="input__group">
            <label for="departure">Check Out</label>
            <input type="date" placeholder="Your Check Out Date" />
          </div>
          <div class="input__group">
      ...
      <div class="room__grid">
        <div class="room__card">
          ...
          <div class="room__card__details">
            ...
            <h3>₱5,000<span>/night</span></h3>
          </div>
        </div>
        <div class="room__card">
          <img src="img/room-2.jpg" alt="room" />
          <div class="room__card__details">
            <div>
              <h4>Family Suite</h4>
              <p>Consist of multiple rooms and a common living area.</p>
            </div>
            <h3>₱7,000<span>/night</span></h3>
          </div>
        </div>
        <div class="room__card">
          <img src="img/room-3.jpg" alt="room" />
          <div class="room__card__details">
            <div>
    ...
    <section class="intro">
      <div class="section__container intro__container">
        ...
        <div class="intro__video">
          <video src="img/luxury.mp4" autoplay muted loop></video>
        </div>
      </div>
    </section>
    ...
    <section class="menu" id="menu">
      <div class="section__container menu__container">
        ...
        <ul class="menu__items">
          <li>
            <img src="img/menu-1.jpg" alt="menu" />
          ...
          <li>
            <img src="img/menu-2.jpg" alt="menu" />
            <div class="menu__details">
              <h4>Tea or Coffee</h4>
              <p>
          ...
          <li>
            <img src="img/menu-3.jpg" alt="menu" />
            <div class="menu__details">
              <h4>Chia Oatmeal</h4>
              <p>
          ...
          <li>
            <img src="img/menu-4.jpg" alt="menu" />
            <div class="menu__details">
              <h4>Fruit Parfait</h4>
              <p>
          ...
          <li>
            <img src="img/menu-5.jpg" alt="menu" />
            <div class="menu__details">
          ...
          <li>
            <img src="img/menu-6.jpg" alt="menu" />
            <div class="menu__details">
              <h4>Cheese Plate</h4>
              <p>
        ...
        <div class="menu__images">
          <img src="img/menu-7.jpg" alt="menu" />
          <img src="img/menu-8.jpg" alt="menu" />
          <img src="img/menu-9.jpg" alt="menu" />
        </div>
    ...
    <footer class="footer">
      <div class="section__container footer__container">
        <div class="footer__col">
          ...
          <p class="section__description">
          Looking for the perfect getaway? KLD Paradise Hotel offers an unforgettable escape, combining stunning accommodations with breathtaking views and exceptional service. Whether you’re seeking relaxation by the pool, gourmet dining, or exciting local adventures, we have it all!
          </p>
      ...
      <div class="footer__bar">
        Copyright © 2024 C-SAJM. All rights reserved.
      </div>
    </footer>
